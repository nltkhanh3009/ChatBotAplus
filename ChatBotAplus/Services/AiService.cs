...
namespace ChatBotAplus.Services
{
    public class AiService
    {
        ...
        public async Task<string> AskGeminiAsync(string question, string context)
        {
            ...
            var systemInstruction = "Bạn là trợ lý AI chuyên nghiệp cho Aplus. Hãy trả lời câu hỏi của người dùng DỰA DUY NHẤT VÀO TÀI LIỆU được cung cấp, nhưng đừng nhắc gì đến tài liệu. Nếu tài liệu không chứa câu trả lời, hãy trả lời lịch sự rằng bạn không có đủ thông tin.";
